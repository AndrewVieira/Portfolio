...
function AboutPage () {
  return (
    <div className="AboutPage">
      <Container>
        <Image className="mt-5" src="undraw_android_jr64.svg" style={{ height: '50vh' }}/>
        <h2>Developer</h2>
...
Id dicam iuvaret quaerendum qui. Nec etiam delenit petentium ea. His in populo corpora, ius omnis erant iisque eu. Vidit verterem vim cu. Pro eu harum mandamus. Erat veritus verterem ut cum.</p>
      </Container>
    </div>
  );
}
